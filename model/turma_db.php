...
function lista_turmas_disciplina($id_disciplina){
    global $db;
    $query = 'SELECT * FROM turma'
...
function adicionar_avaliacao_turma($id_turma, $id_avaliacao){
    global $db;
    $query = 'INSERT INTO turma_avaliacao
                 (id_avaliacao, id_turma)
              VALUES
                 (:id_avaliacao, :id_turma)';
    $statement = $db->prepare($query);
    $statement->bindValue(':id_turma', $id_turma);
